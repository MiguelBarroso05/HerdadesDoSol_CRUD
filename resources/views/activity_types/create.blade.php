            ...
            <div class="row gx-4">
                ...
                <div class="container-fluid py-4">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <form method="POST" action="{{route('activity_types.store')}}" enctype="multipart/form-data">
                                @csrf
                                @if(session('success'))
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row d-flex flex-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-control-label">Select Activity Image</label>
                                                    <div class="d-flex flex-wrap image-selection-group">
                                                        @foreach (File::files(public_path('imgs/activities')) as $file)
                                                                <?php $filename = pathinfo($file, PATHINFO_BASENAME); ?>
                                                            <div class="image-option" data-value="{{ $filename }}">
                                                                <img
                                                                    src="{{ asset('imgs/activities/' . $filename) }}"
                                                                    alt="{{ $filename }}">
                                                            </div>
                                                        @endforeach
                                                    </div>
